...
class model_o3_err_1param(nn.Module):
    def __init__(self, hidden, dr, channels):
        super(model_o3_err_1param, self).__init__()
        ...
        self.FC1  = nn.Linear(128*hidden, 64*hidden)
        self.FC2  = nn.Linear(64*hidden,  2)  # TODO
...
class model_o3_err_cosmology(nn.Module):
    def __init__(self, hidden, dr, channels):
        super(model_o3_err_cosmology, self).__init__()
        ...
        self.FC1  = nn.Linear(128*hidden, 64*hidden)
        self.FC2  = nn.Linear(64*hidden,  4)  # TODO
    ...
    def forward(self, image):
        ...
        y[:,2:3] = torch.square(x[:,2:3])

        return y


class model_o3_err_18layers(nn.Module):
    def __init__(self, hidden, dr, channels):
        super(model_o3_err_18layers, self).__init__()
...
class model_o3_err_da(nn.Module):
    def __init__(self, hidden, dr, channels):
        super(model_o3_err_da, self).__init__()
